    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Symptoms", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginCredentialsUsername = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_LoginCredentials_LoginCredentialsUsername",
                        column: x => x.LoginCredentialsUsername,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_LoginCredentialsUsername",
                table: "Users",
                column: "LoginCredentialsUsername");
        }
